...
/* Private variables ---------------------------------------------------------*/
/* Definitions for GreenFlashTask */
osThreadId_t GreenFlashTaskHandle;
const osThreadAttr_t GreenFlashTask_attributes = {
  .name = "GreenFlashTask",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
/* Definitions for RedFlashTask */
osThreadId_t RedFlashTaskHandle;
const osThreadAttr_t RedFlashTask_attributes = {
  .name = "RedFlashTask",
  .stack_size = 128 * 4,
...
/* USER CODE BEGIN Header_StartGreenFlashingTask */
/**
  * @brief  Function implementing the GreenFlashTask thread.
...
/* USER CODE BEGIN Header_StartRedFlashingTask */
/**
* @brief Function implementing the RedFlashTask thread.
* @param argument: Not used
* @retval None
*/
...
void StartRedFlashingTask(void *argument)
{
  ...
  /* USER CODE END StartRedFlashingTask */
}
